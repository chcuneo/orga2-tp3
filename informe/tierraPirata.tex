...
\item \fun{remap(uint directoryBase, uint virtualAddress, uint physicalAddress)}: Remappea la pagina 

\item \fun{getPhysVirt(uint directoryBase, uint virtualAddress)}:

\item \fun{isMapped(uint directoryBase, uint virtualAddress)}:
