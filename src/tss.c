...
uint lastUninitializedGDTEntry = GDT_IDX_TASKI_DESC + 1;
...
int tss_inicializar() {
	...
	gdt[GDT_IDX_TASKB_DESC] = (gdt_entry) {
		(ushort)    0x0067,         /* limit[0:15]  */
		(ushort)    &tss_inicial & (0x0000FFFF),         /* base[0:15]   */
		(uchar)     (&tss_inicial & (0x00FF0000)) >> 16, /* base[23:16]  */
		(uchar)     0x0B,           /* type         */
		(uchar)     0x00,           /* s            */
		(uchar)     0x00,           /* dpl          */
		(uchar)     0x01,           /* p            */
		...
		(uchar)     0x00,           /* db           */
		(uchar)     0x00,           /* g            */
		(uchar)     (&tss_inicial & (0xFF000000)) >> 24, /* base[31:24]  */
	},

	// Tarea idle
	gdt[GDT_IDX_TASKI_DESC] = (gdt_entry) {
		(ushort)    0x0067,         /* limit[0:15]  */
		(ushort)    &tss_idle & (0x0000FFFF),         /* base[0:15]   */
		(uchar)     (&tss_idle & (0x00FF0000)) >> 16, /* base[23:16]  */
		(uchar)     0x09,           /* type         */
		(uchar)     0x00,           /* s            */
		(uchar)     0x00,           /* dpl          */
		(uchar)     0x01,           /* p            */
		...
		(uchar)     0x00,           /* db           */
		(uchar)     0x00,           /* g            */
		(uchar)     (&tss_idle & (0xFF000000)) >> 24, /* base[31:24]  */
	}

	tss_gdt_inicializar_bache((uint)&tss_jugadorA, MAX_CANT_PIRATAS_VIVOS);
	tss_gdt_inicializar_bache((uint)&tss_jugadorB, MAX_CANT_PIRATAS_VIVOS);
